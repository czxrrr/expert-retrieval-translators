...
\begin{subfigure}{.3\textwidth}
  \centering
	\includegraphics[width=0.8\textwidth]{figures/aggregation_plots_gp2.png}
	\caption{GP2}
\end{subfigure}%
\begin{subfigure}{.3\textwidth}
  \centering
	\includegraphics[width=0.8\textwidth]{figures/aggregation_plots_top5.png}
	\caption{TOP5}
\end{subfigure}%
\begin{subfigure}{.3\textwidth}
  \centering
	\includegraphics[width=0.8\textwidth]{figures/aggregation_plots_top1.png}
	\caption{TOP1}
\end{subfigure}
